    ...
    >
      <div className="h-[100vh] w-full relative  flex flex-row items-center justify-start">
        <div className="flex flex-col items-start w-9/12 sm:w-8/12 lg:w-6/12 xl:w-6/12 2xl:w-6/12 px-4 z-40">
          <h2 data-aos="fade-right" className="text-4xl font-bold text-white">
          ...
          <div className="flex flex-col items-start sm:flex-row sm:items-center   w-full sm:w-9/12 mt-8 ">
            ...
            <button className="mt-4 sm:mt-0 sm:ml-4 border border-white text-white  rounded-md  px-4 py-3 hover:bg-white hover:text-indigo-700 transition-colors duration-500">
              VIEW MARKET
            </button>
          </div>
        </div>
