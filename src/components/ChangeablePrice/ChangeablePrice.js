...
const ChangeablePrice = ({
  ...
  return (
    color?<div className={`${customMargin} flex flex-col items-center justify-between h-auto w-full`}>
            <div className={`w-10/12 h-[2px]  border-t-2 border-${color} border-dashed`}></div>
          ...
          <div className={`${customMargin}  flex flex-col items-center justify-between h-auto w-full`}>
