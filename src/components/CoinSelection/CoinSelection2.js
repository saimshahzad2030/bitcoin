    ...
    <div className="flex flex-col items-center w-full mt-20 mb-8">
      <div className="w-8/12 sm:w-4/12 flex felx-col items-center">
        <select
          ...
          className={` block appearance-none text-indigo-700 w-full bg-white border border-indigo-700 hover:border-indigo-400 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:border-indigo-500 `}
        >
