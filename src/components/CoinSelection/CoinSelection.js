...
const CoinSelection = ({selectedCoin,
    ...
    <div className="flex flex-col items-center w-full mt-20">
        <div className="w-8/12 sm:w-4/12 flex felx-col items-center">
          <select
            ...
            className={` block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:border-indigo-500 ${!isCoinSelected ? 'my-20' : ''}`}
          >
            <option style={{ display: isCoinSelected ? 'none' : '' }} value={'select a coin'}>
              select a coin
            </option>
