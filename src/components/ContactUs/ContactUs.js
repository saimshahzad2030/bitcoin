      ...
      <div className=" container mx-auto">
        <div className=" flex flex-col items-center pt-20  postsenOne">
          <div className=" z-20 grid grid-cols-1 md:grid-cols-2 mt-12  relative">
            ...
            <form className="flex flex-col items-center justify-center w-full shadow-2xl mt-12 md:mt-56 py-8 bg-white">
              <h1 className="text-3xl font-bold   ">SAY SOMETHING</h1>
              <input
                type="email"
