...
export const weightedAveragePrice = (levelArray,numberOfTokens)=>{
 ...
 export const totalRevenue = (levelArray,numberOfTokens)=>{
  ...
  export const totalProfit = (levelArray,averagePurchasePrice,numberOfTokens)=>{ 
    return totalRevenue(levelArray,numberOfTokens) - (averagePurchasePrice*numberOfTokens)
  }

  export const returnOnServiceEachLevel = (level,averagePurchasePrice,numberOfTokens)=>{
